  ...
  return (
    <section id="opensource" className="relative py-32" ref={ref}>
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 60% 40% at 50% 30%, oklch(0.60 0.15 220 / 0.05) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="container relative z-10">
        ...
        <div className="text-center mb-20 reveal">
          <div
            ...
            style={{
              ...
              background: "oklch(0.60 0.15 220 / 0.08)",
          ...
          >
            黄庭协议将以GitHub开源项目的形式向全球开发者、研究者和修行者开放。
            我们相信，这套理论的价值只有在开放生态中才能得到最大释放。
          </p>
        </div>
          ...
          <div className="reveal">
            ...
            >
              ...
              <div className="p-4">
                ...
                {repoStructure[0].children.map((item) => (
                  <div
                    key={item.path}
                    className="flex items-center gap-3 py-1.5 pl-4"
                  >
                    <span style={{ color: "oklch(0.50 0.04 270)", fontSize: "0.75rem" }}>
                      {item.type === "dir" ? "📁" : "📄"}
                    </span>
                    <span
                      style={{
                        fontFamily: "'JetBrains Mono', monospace",
                        fontSize: "0.78rem",
                        color: item.type === "dir" ? "oklch(0.78 0.14 75)" : "oklch(0.65 0.12 175)",
                      }}
                    >
                      {item.path}
                    </span>
        ...
        <div className="text-center mt-16 reveal">
          <div
            className="inline-flex flex-col items-center gap-6 p-10 rounded-xl"
            style={{
